        ...
        <>
            ...
            <Select.Select id="ca"
                ...
                onChange={value => onValueChanged("ca", value)}>
                    {cas.map(ca => {
                        return (
                        <Select.SelectEntry data={ca} key={ca}>
                            {ca}
                        </Select.SelectEntry>
                        );
                    })}
    ...
    return (
        <>
            ...
            <TextInput value={dialogValues.nickname}
                ...
                aria-label="Nickname input text" />
        </>
    );
}
...
export class RequestCertificate extends React.Component {
    constructor(props) {
        ...
        this.state = {
            showDialog: false,
            ca: props.cas[Object.keys(props.cas)[0]] ? props.cas[Object.keys(props.cas)[0]].aka.v : undefined,
            storage: "nssdb",
            nickname: "",
            certFile: "",
            keyFile: "",
    ...
    onRequest() {
        ...
        let caPath;
        casKeys.forEach(key => {
            if (this.props.cas[key].aka.v === this.state.ca)
                caPath = key;
        });
    ...
    render() {
        const cas = Object.values(this.props.cas).map(obj => obj.aka.v);
        ...
        return (
            <>
                ...
                <Modal id="request-certificate-dialog" onHide={this.onClose} show={showDialog}>
                    <Modal.Header>
                    ...
                    <Modal.Footer>
                        ...
                        <Button variant="link" className="btn-cancel" onClick={this.onClose}>
                            {_("Cancel")}
                        </Button>
                    </Modal.Footer>
                </Modal>
